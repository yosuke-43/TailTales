...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<actionpack>.freeze, [">= 6.0.0".freeze, "< 7.2".freeze])
  ...
  s.add_development_dependency(%q<standard>.freeze, ["~> 1.31".freeze])
  s.add_development_dependency(%q<rubocop-rails>.freeze, ["~> 2.23.0".freeze])
