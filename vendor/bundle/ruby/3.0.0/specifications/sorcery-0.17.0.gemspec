...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<oauth>.freeze, [">= 0.6".freeze])
  s.add_runtime_dependency(%q<oauth2>.freeze, ["~> 2.0".freeze])
  s.add_development_dependency(%q<byebug>.freeze, ["~> 10.0.0".freeze])
  s.add_development_dependency(%q<rspec-rails>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<rubocop>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<simplecov>.freeze, [">= 0.3.8".freeze])
  s.add_development_dependency(%q<test-unit>.freeze, ["~> 3.2.0".freeze])
  s.add_development_dependency(%q<timecop>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<webmock>.freeze, ["~> 3.3.0".freeze])
  s.add_development_dependency(%q<yard>.freeze, ["~> 0.9.0".freeze, ">= 0.9.12".freeze])
end
